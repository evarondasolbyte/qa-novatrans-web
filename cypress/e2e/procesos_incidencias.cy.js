describe('PROCESOS (INCIDENCIAS) - Validación completa con gestión de errores y reporte a Excel', () => {
    ...
    const casos = [
        { numero: 1, nombre: 'TC001 - Cargar la pantalla correctamente', funcion: cargarPantallaIncidencias },
        ...
        { numero: 6, nombre: 'TC006 - Filtrar por Fecha', funcion: filtrarPorFecha },
        { numero: 7, nombre: 'TC007 - Filtrar por Incidencia', funcion: filtrarPorIncidencia },
        { numero: 8, nombre: 'TC008 - Filtrar por P.T', funcion: filtrarPorPT },
        { numero: 9, nombre: 'TC009 - Filtrar por Tipo incidencia', funcion: filtrarPorTipoIncidencia },
        { numero: 10, nombre: 'TC010 - Filtrar por Resolución', funcion: filtrarPorResolucion },
        { numero: 11, nombre: 'TC011 - Filtrar por Id. Planificación', funcion: filtrarPorIdPlanificacion },
        ...
        { numero: 15, nombre: 'TC015 - Búsqueda con espacios', funcion: buscarConEspacios },
        { numero: 16, nombre: 'TC016 - Búsqueda con caracteres especiales', funcion: buscarCaracteresEspeciales },
        { numero: 17, nombre: 'TC017 - Ordenar por Código ASC/DESC', funcion: ordenarPorCodigo },
        { numero: 18, nombre: 'TC018 - Ordenar por Fecha ASC/DESC', funcion: ordenarPorFecha },
        { numero: 19, nombre: 'TC019 - Ordenar por Incidencia ASC/DESC', funcion: ordenarPorIncidencia },
        { numero: 20, nombre: 'TC020 - Ordenar por P.T ASC/DESC', funcion: ordenarPorPT },
        { numero: 21, nombre: 'TC021 - Ordenar por Tipo incidencia ASC/DESC', funcion: ordenarPorTipoIncidencia },
        { numero: 22, nombre: 'TC022 - Ordenar por Resolución ASC/DESC', funcion: ordenarPorResolucion },
        { numero: 23, nombre: 'TC023 - Ordenar por Id. Planificación ASC/DESC', funcion: ordenarPorIdPlanificacion },
        { numero: 24, nombre: 'TC024 - Seleccionar una fila', funcion: seleccionarFila },
        { numero: 25, nombre: 'TC025 - Eliminar con fila seleccionada', funcion: eliminarConSeleccion },
        { numero: 26, nombre: 'TC026 - Eliminar sin selección', funcion: eliminarSinSeleccion },
        { numero: 27, nombre: 'TC027 - +Añadir abre formulario', funcion: abrirFormularioAlta },
        { numero: 28, nombre: 'TC028 - Editar con fila seleccionada', funcion: editarConSeleccion },
        { numero: 29, nombre: 'TC029 - Editar sin selección', funcion: editarSinSeleccion },
        { numero: 30, nombre: 'TC030 - Fecha Desde (filtro superior)', funcion: filtrarFechaDesde },
        { numero: 31, nombre: 'TC031 - Fecha Hasta (filtro superior)', funcion: filtrarFechaHasta },
        { numero: 32, nombre: 'TC032 - Fecha Desde + Hasta (rango)', funcion: filtrarRangoFechas },
        { numero: 33, nombre: 'TC033 - Filter → Value en columna', funcion: filtrarPorValue },
        { numero: 34, nombre: 'TC034 - Ocultar columna desde menú contextual', funcion: ocultarColumna },
        { numero: 35, nombre: 'TC035 - Manage columns (mostrar/ocultar)', funcion: gestionarColumnas },
        { numero: 36, nombre: 'TC036 - Scroll vertical/horizontal', funcion: scrollTabla },
        { numero: 37, nombre: 'TC037 - Reinicio de filtros al recargar', funcion: reinicioFiltros },
    ];
